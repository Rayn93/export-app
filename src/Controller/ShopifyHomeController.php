...
class ShopifyHomeController extends AbstractController
{
    public function __construct(private readonly ShopifyOauthTokenRepository $shopifyOauthTokenRepository)
    {
    }
